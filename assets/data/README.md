...
cd apps/examples
./run_vision.sh
# 输入: ../assets/data/images/bee.jpg

# 音频转录
./run_audio.sh
# 输入: ../assets/data/audio/mlk_speech.flac
```
...
```bash
# 添加图片
cp your_image.jpg assets/data/images/

# 添加音频 (支持 wav, mp3, flac, ogg)
cp your_audio.wav assets/data/audio/
```
