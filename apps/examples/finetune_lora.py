...
output_dir = str(root_dir / "artifacts/lora")
data_path = str(root_dir / "assets/data/train.jsonl")
...
print("\n下一步:")
print("  1. 运行 ./run_test_finetuned.sh 测试微调效果")
print("  2. 运行 ./run_merge.sh 合并权重")
print("=" * 60)
